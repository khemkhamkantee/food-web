...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add Medical problems</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">HOME</a></li>
                            <li class="breadcrumb-item">Medical problems</li>
                            <li class="breadcrumb-item active">Add Medical problems</li>
                        </ol>
                    </div>
                </div>
                <form action="../main/add-medical-problems.php" method="POST" class="form-horizontal form-material" name="form1" runat="server">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row ml-1 mr-1 mt-3">
                                            ...
                                            <div class="col-md-11 mb-4" id="process">
                                                <input type="text" name="medical_problems" placeholder="โรคหัวใจ" class="form-control form-control-line">
                                            </div>
                                            <!-- <button href="" onclick="AddCongenitaldisease()" id="get" type="button" class="btn btn-danger btn-block"><i class="fa fa-plus-circle" aria-hidden="true"></i></button> -->
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <center>
                                            <button type="submit" class="btn btn-success btn-block">Add Medical problems</button>
                                        </center>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- <script>
        ...
        function AddCongenitaldisease() {
            ...
            process += ' <input type="text" placeholder="Medical problems " class="form-control form-control-line">';
