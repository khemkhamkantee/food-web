...
$sql = "SELECT * FROM medical_problems WHERE user_id=$session_login_id";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Medical problems</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Medical problems</li>
                        </ol>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <a href="add-medical-problems.php" class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down">Add Medical problems <i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                    </div>
                </div>
                <div class="row">
                    <!-- column -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex m-b-30 no-block">
                                    <h4 class="card-title">Food for your Medical problems</h4>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $row["tb_medical_problems"]; ?></td>
                                                    <td>
                                                        <a href=""><i class="fa fa-eye text-success ml-3 mr-3" style="font-size: 1.25rem;"></a></i>
                                                        <a href="../main/delete-medical-problems.php?id=<?= $row["id"]; ?>"><i class="fa fa-trash-o text-danger" style="font-size: 1.25rem;"></i></a>
                                                    </td>
                                                </tr>
                                            <?php $i++;
                                            } ?>
