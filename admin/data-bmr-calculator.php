...
$sql = "SELECT * FROM user INNER JOIN calories ON user.id=calories.user_id";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">All data BMR Calculator</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">All data BMR Calculator</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"> All data BMR Calculator</h4>
                                <h6 class="card-subtitle">Manage All data BMR Calculator</h6>
                                        ...
                                        <?php
                                            ...
                                            while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../main/delete-admincalculator.php?id=<?= $row["id"]; ?>"><i class="fa fa-trash-o text-danger" style="font-size: 1.25rem;"></i></a></td>
                                                    </td>
                                                </tr>
                                            <?php $i++;
                                            } ?>
