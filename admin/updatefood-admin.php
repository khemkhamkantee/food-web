...
$resultingredients1 = mysqli_query($conn, $ingredients1);
$resultingredients2 = mysqli_query($conn, $ingredients2);
$resultingredients3 = mysqli_query($conn, $ingredients3);

$resultpreparation1 = mysqli_query($conn, $preparation1);
$resultpreparation2 = mysqli_query($conn, $preparation2);
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <form action="../main/updatefood-user.php" onsubmit="return Validate()" enctype="multipart/form-data" method="POST" class="form-horizontal form-material" name="form1" runat="server">
