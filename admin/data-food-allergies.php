...
$sql = "SELECT * FROM user INNER JOIN food_allergies ON user.id=food_allergies.user_id";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">All data Food allergies</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">All data Food allergies</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"> All data Food allergies</h4>
                                <h6 class="card-subtitle">Manage All data Food allergies</h6>
                                        ...
                                        <?php
                                            ...
                                            while ($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../main/delete-adminfood-allergies.php?id=<?= $row["id"]; ?>"><i class="fa fa-trash-o text-danger" style="font-size: 1.25rem;"></i></a>
                                                    </td>
                                                </tr>
                                            <?php $i++;
                                            } ?>
