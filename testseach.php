...
<header class="masthead text-white text-center" style="background-image: url('img/img-index.jpg') ;">
    <div class="container">
        ...
        <!-- Modal -->
        <form action="main/search.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mySlides">
                                <div class="col-10" id="searchfood_allergies">
                                    <div class="text-muted text-left mb-2">Food allergies</div>
                                    <select name="namefood_allergies1" class="form-control form-control-line">
                                ...
                                <div class="col-2 mt-3">
                                    <button onclick="addfood_allergies()" id="get" type="button" class="btn btn-danger mt-3"><i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                                </div>
                            </div>
                            <button type="button" class="w3-button w3-display-left w3-black" onclick="plusDivs(-1)">&#10094;</button>
                            <button type="button" class="w3-button w3-display-right w3-black" onclick="plusDivs(1)">&#10095;</button>
