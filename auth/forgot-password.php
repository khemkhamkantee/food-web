...
<body>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <!-- Login Form -->
            <form ction="../main/forgot-password.php" method="POST">
                <input type="text" id="email" class="fadeIn second" name="email" placeholder="email">
                <input type="password" id="new_password" class="fadeIn third" name="new_password" placeholder="new password">
                <input type="password" id="confirm_password" class="fadeIn third" name="confirm_password" placeholder="confirm new password">
                <input type="submit" class="fadeIn fourth" value="Log In">
            </form>

            <!-- Remind Passowrd -->
            <div id="formFooter">
                Yor have an account? <a class="underlineHover" href="login.php">Login</a><br>
