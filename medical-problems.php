...
<body>
    ...
    <!-- Masthead -->
    <header class="masthead text-white text-center" style="background-image: url('https://ichef.bbci.co.uk/news/976/cpsprodpb/92EE/production/_101841673_medicine_gettyimages-493249762.jpg') ;">
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h1 class="mb-5">Medical problems</h1>
                </div>
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <div class="form-row input-group ml-2">
                        <!-- Button trigger modal -->
                        <div class="col-10 col-md-10 mb-2 mb-md-0 mt-2 ml-5" id="table1" name="table1">
                            <input type="text" class="form-control mb-3" placeholder="โรค">
                        </div>
                        <div class="col-10 col-md-10 mb-2 mb-md-0 mt-2 ml-5">
                            <button href="" onclick="addRules()" id="get" type="button" class="btn btn-danger btn-block">Increase Medical problems <i class="fa fa-plus-circle" aria-hidden="true"></i></button>
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                <div class="col-lg-12 order-lg-1 showcase-text">
                    <h2 class="">Medical problems</h2>
                    <p class="lead">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; A birth defect, also known as
                        a congenital disorder, is a condition present at birth regardless of its cause. Birth defects may result in disabilities
                        that may be physical, intellectual, or developmental. The disabilities can range from mild to severe. Birth defects are
                        divided into two main types: structural disorders in which problems are seen with the shape of a body part and functional
                        disorders in which problems exist with how a body part works. Functional disorders include metabolic and degenerative
                        disorders. Some birth defects include both structural and functional disorders.</p>
                </div>
            </div>
    ...
    <script>
        function addRules() {
            ...
            var newid = id++;
            var test = '';
            test += '<input type="text" class="form-control mb-3" placeholder="โรค">';
            $("#table1").append(test);
        }
        // On top
